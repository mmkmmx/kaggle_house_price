...
# Alley:        1352  categorical - replace NAs with 'noAlley'
# Utilities:       2  categorical - I think we should remove this variable, it has no variability to it
...
table(dtest$SaleType)  # <-- see what each variable looks like, one at a time
table(dtest$SaleType)  # <-- see what each variable looks like, one at a time
```
